...
# CONFIG
# ==============================
CONF_THRESH = 0.6 # tune as needed
ENTROPY_THRESH = 1.2 # tune as needed
WINDOW_SECONDS = 3
UPDATE_SECONDS = 0.25
NUM_CLASSES = 5
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Piano Hand Posture Detection")
    parser.add_argument("--model_path", type=str, required=True, help="Path to the trained ST-GCN model")
